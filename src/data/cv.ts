  ...
  positions: [
    {
      ...
      bodyHtml:
        '<ul>\n<li>Established the primary evaluation platform for GitHub Copilot\'s flagship coding agents—<a href="https://code.visualstudio.com/docs/agents/overview">VS Code Agent</a>, <a href="https://docs.github.com/en/copilot/how-tos/use-copilot-agents/cloud-agent">Copilot Cloud Agent</a>, and <a href="https://github.com/features/copilot/cli">Copilot CLI</a>—by <strong>starting and scaling its core science from a greenfield prototype to 1M+ monthly benchmark executions</strong>.</li>\n<li>Led training, evaluation, and rollout of customizable <a href="https://code.visualstudio.com/docs/editing/ai-powered-suggestions">GitHub Copilot Inline Suggestions</a>, <strong>addressing 10+ community issues and increasing accepted suggestions by 10%</strong>.</li>\n</ul>\n',
    },
    {
