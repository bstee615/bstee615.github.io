  ...
  positions: [
    {
      ...
      bodyHtml:
        '<ul>\n<li>Drove research engineering for <strong>GitHub Copilot\'s primary agentic evaluation platform</strong>, building its scalable harness environment &amp; tooling and onboarding key benchmarks. During my tenure, we grew it from a <strong>greenfield prototype to 1M+ monthly executions</strong>, and it now powers evaluations for flagship coding agents, including <a href="https://code.visualstudio.com/docs/agents/overview">VS Code Agent</a>, <a href="https://docs.github.com/en/copilot/how-tos/use-copilot-agents/cloud-agent">Copilot Cloud Agent</a>, and <a href="https://github.com/features/copilot/cli">Copilot CLI</a>.</li>\n<li>Led post-training, evaluation, and rollout of a production model for <a href="https://code.visualstudio.com/docs/editing/ai-powered-suggestions">GitHub Copilot Inline Suggestions</a> that <strong>increased suggestion acceptance by 10%</strong> and enabled a configurable eagerness feature that <strong>addressed 10+ long-standing community issues</strong>.</li>\n</ul>\n',
    },
    {
