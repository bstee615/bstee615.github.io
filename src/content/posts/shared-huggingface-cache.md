...
description: >-
  My lab members and I use a shared machine to run, among other things, large language model inference using the
  transformers and datasets libraries. HuggingFace libraries download the model weights or datasets, and the downloaded
