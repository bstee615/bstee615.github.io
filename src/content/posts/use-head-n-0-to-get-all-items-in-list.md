...
description: >-
  You may know that you can use head -n $n to get the first N lines of a list. But you may not know that you can supply
  n=-0 to get all items in the list.
date: 2022-07-01T00:00:00.000Z
tags:
  - stream
  - tips
kind: stream
legacyUrl: /stream/use-head-n-0-to-get-all-items-in-list/
---
