...
description: >-
  I used to use earlyoom to ensure that my desktop PC will still keep running if a program hogs all the memory (e.g.
  loading a too-large dataset into memory). I recently couldn't get earlyoom to work with Fedora 37, and while searching
  for a solution I found nohang. Here are some useful features of nohang which convinced me to switch:
date: 2023-02-13T00:00:00.000Z
tags:
  - stream
  - tools
kind: stream
legacyUrl: /stream/friendship-ended-with-earlyoom/
---
...
![OOM notification](/files/nohang_notification.png)
