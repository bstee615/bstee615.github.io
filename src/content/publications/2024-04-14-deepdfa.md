...
summary: >-
  We present DeepDFA, a dataflow analysis-inspired graph learning framework and an embedding technique that enables
  graph learning to simulate dataflow computation.
...
authors:
  ...
  - Wei Le
citation: >-
  Benjamin Steenhoek, Hongyang Gao, and Wei Le. 2024. Dataflow Analysis-Inspired Deep Learning for Efficient
  Vulnerability Detection. In 2024 IEEE/ACM 46th International Conference on Software Engineering (ICSE ’24), April
  14–20, 2024, Lisbon, Portugal.
tags: []
links:
  - label: Paper
    url: https://doi.org/10.48550/arXiv.2212.08108
  - label: Code
    url: https://github.com/ISU-PAAL/DeepDFA
selected: true
visual: dataflow
---
