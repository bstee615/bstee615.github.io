...
summary: >-
  In this paper, we surveyed and reproduced 9 state-of-the-art (SOTA) deep learning models on 2 widely used
  vulnerability detection datasets: Devign and MSR.
date: 2023-05-14
venue: ICSE
...
authors:
  ...
  - Wei Le
citation: >-
  Benjamin Steenhoek, Md Mahbubur Rahman, Richard Jiles, and Wei Le. 2023. An Empirical Study of Deep Learning Models
  for Vulnerability Detection. In Proceedings of the 45th International Conference on Software Engineering (ICSE 2023).
links:
  - label: Paper
    url: https://doi.org/10.48550/arXiv.2212.08109
  - label: Code
    url: https://github.com/ISU-PAAL/DL-VD-Empirical-Study
selected: true
---
