...
summary: >-
  In this paper, we analyze language models to investigate whether the models have learned the semantics of code
  relevant to vulnerability detection, namely bug semantics, and if so, how the alignment to bug semantics relates to
  model performance.
date: 2023-11-07
venue: ArXiv
...
authors:
  ...
  - Wei Le
citation: >-
  Benjamin Steenhoek, Md Mahbubur Rahman, Shaila Sharmin, & Wei Le. (2023). Do Language Models Learn Semantics of Code?
  A Case Study in Vulnerability Detection. ArXiv.
links:
  - label: Paper
