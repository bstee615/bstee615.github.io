...
summary: >-
  We propose CodeSense, the first benchmark with a spectrum of fine-grained code reasoning tasks from real-world
  software projects, revealing a clear performance gap in state-of-the-art LLMs for code semantic reasoning.
date: 2026-04-23
venue: ICLR
...
authors:
  ...
  - Wei Le
citation: >-
  Monoshi Kumar Roy, Simin Chen, Benjamin Steenhoek, Jinjun Peng, Gail Kaiser, Baishakhi Ray, and Wei Le. 2026.
  CodeSense: a Real-World Benchmark and Dataset for Code Semantic Reasoning. In The Fourteenth International Conference
  on Learning Representations (ICLR 2026), April 24–28, 2026, Singapore.
links:
  - label: Paper
    url: https://arxiv.org/abs/2506.00750
  - label: Code
    url: https://github.com/codesense-bench/codesense-codes
selected: true
visual: trace
---
